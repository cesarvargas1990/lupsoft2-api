...
return [
    ...
    'POST /cuotas_pendientes_hoy' => [
        ...
        'response' => 'array<object{id:int,id_cliente:int,id_prestamo:int,nomcliente:string,celular?:string,fecha_pago:string,fecha_pago_texto:string,valcuota:string,valtotal:string}>'
    ],
